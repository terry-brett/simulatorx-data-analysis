...
# load data for Westminster from https://www.nomisweb.co.uk/reports/localarea?compare=E09000033
data = read_file("../data/westminster_demographics.csv")
# 113 days
...
gov_uk_data = pd.read_csv('../data/westminster_gov_uk_data.csv',index_col=0)
dff = pd.DataFrame()
...
plt.plot(dff)
plt.title('SIS v/s NHS for Westminster', fontsize=15)
plt.xlabel('Days')
plt.ylabel('Cases')
